...
import com.demo.crawler.crawl.sougouweixin.utils.CommonUtil;
...
public class PageData<T> {
    ...
    /**
     * 推送的信息的对象 SendSpriderDto
     */
    private List<SendSpriderDto> sendList;
...
//        return totalPage;
    ...
    public List<SendSpriderDto> getSendList() {
        return sendList;
    }

    public void setSendList(List<SendSpriderDto> sendList) {
        this.sendList = sendList;
    }

    public void addSendList(SendSpriderDto obj) {
